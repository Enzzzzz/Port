    ...
    <section id="about" className="py-20 bg-background px-4 md:px-8 lg:px-16">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-poppins font-bold mb-4 text-text">
            Sobre Mim
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 font-poppins mb-16">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-xl mb-2 text-text font-poppins">{feature.title}</h3>
        ...
        <div className="max-w-4xl mx-auto">
          <h3 className="text-3xl font-bold mb-8 font-poppins text-center text-text">
